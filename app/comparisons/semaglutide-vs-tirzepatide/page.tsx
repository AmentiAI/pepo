    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--bg)' }}>
          ...
          <div className="grid sm:grid-cols-3 gap-4 mt-8">
            {[
              ...
              <div key={card.label} className="card p-5" style={{ background: card.bg, borderColor: card.border }}>
                <p className="text-zinc-500 text-xs font-medium uppercase tracking-wider mb-2">{card.label}</p>
                <p className={`text-xl font-extrabold mb-1 ${card.accent}`}>{card.winner}</p>
                <p className="text-zinc-400 text-sm leading-relaxed">{card.reason}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-10 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">How Each Generation Works</h2>
          ...
          <div className="space-y-6 mb-10">
            <div className="card p-6" style={{ borderColor: 'rgba(16,185,129,0.3)' }}>
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-white font-bold text-lg">Semaglutide — Single GLP-1 Agonist</h3>
              </div>
            ...
            <div className="card p-6" style={{ borderColor: 'rgba(96,165,250,0.3)' }}>
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-white font-bold text-lg">Tirzepatide — Dual GIP + GLP-1 Agonist</h3>
              </div>
              <p className="text-zinc-400 leading-relaxed mb-3">
            ...
            <div className="card p-6" style={{ borderColor: 'rgba(167,139,250,0.3)' }}>
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-white font-bold text-lg">Retatrutide — Triple GIP + GLP-1 + Glucagon Agonist</h3>
              </div>
              <p className="text-zinc-400 leading-relaxed mb-3">
              ...
              <p className="text-zinc-400 leading-relaxed">
                ...
                See the <Link href="/retatrutide" className="text-violet-400 hover:underline">full Retatrutide guide</Link> for protocol details.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-10 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8">Head-to-Head Clinical Comparison</h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr style={{ borderBottom: '1px solid #2a2a3e' }}>
                  ...
                  <th className="text-left py-3 px-4 text-violet-400 font-semibold">Retatrutide</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={label} style={{ borderBottom: '1px solid #1e1e35' }}>
                    ...
                    <td className="py-3 px-4 text-zinc-300">{sema}</td>
                    <td className="py-3 px-4 text-zinc-300">{tirze}</td>
                    <td className="py-3 px-4 text-zinc-300">{reta}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          {/* Weight Loss Visual */}
          <h3 className="text-white font-bold text-xl mb-4">Average Weight Loss Comparison</h3>
          <div className="space-y-3 mb-10">
            {[
              ...
              <div key={item.name} className="flex items-center gap-4">
                <span className="text-zinc-400 text-sm w-44 shrink-0">{item.name}</span>
      ...
      <section className="py-10 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8">Which Should You Choose?</h2>
          ...
          <div className="space-y-4 mb-10">
            ...
            <div className="card p-5" style={{ borderColor: 'rgba(167,139,250,0.3)' }}>
              <p className="text-violet-400 font-bold mb-2">Choose Retatrutide if:</p>
              <ul className="space-y-1 text-sm text-zinc-400">
                <li className="flex gap-2"><CheckCircle2 size={14} className="text-violet-400 shrink-0 mt-0.5" />Maximum fat loss rate is the goal and you are comfortable with Phase 2 data</li>
                <li className="flex gap-2"><CheckCircle2 size={14} className="text-violet-400 shrink-0 mt-0.5" />You want the thermogenic component that neither GLP-1 nor dual agonists provide</li>
                <li className="flex gap-2"><CheckCircle2 size={14} className="text-violet-400 shrink-0 mt-0.5" />You have significant visceral or hepatic fat — glucagon component specifically targets liver fat</li>
                <li className="flex gap-2"><CheckCircle2 size={14} className="text-violet-400 shrink-0 mt-0.5" />You have already run semaglutide and/or tirzepatide and are looking for the next step</li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <Link href="/glp1-comparison" className="card p-5 hover:border-emerald-500/40 transition-colors block">
              ...
              <p className="text-zinc-400 text-sm">Full GLP-class guide including Cagrilintide (CAGRI-SEMA) and extended protocol guides.</p>
            ...
            <Link href="/best-peptide-for-weight-loss" className="card p-5 hover:border-blue-500/40 transition-colors block">
              ...
              <p className="text-zinc-400 text-sm">Ranked guide covering all weight loss peptides — GLP-class, GH peptides, and metabolic supports.</p>
      ...
      <section className="py-10 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Stacking GLP Peptides with GH Support</h2>
          <p className="text-zinc-400 leading-relaxed mb-6">
            One of the most effective advanced protocols combines a GLP-class peptide for fat loss with
            <Link href="/peptides/ipamorelin-cjc" className="text-violet-400 hover:underline"> Ipamorelin + CJC-1295</Link> for
          ...
          <p className="text-zinc-400 leading-relaxed mb-8">
            <Link href="/products/bpc-157" className="text-violet-400 hover:underline">BPC-157</Link> is
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <Link href="/stacks/glp1-fat-loss" className="card p-5 hover:border-emerald-500/40 transition-colors block">
              ...
              <p className="text-zinc-400 text-sm">Pre-built GLP + GH support protocol with week-by-week guidance.</p>
            ...
            <Link href="/body-composition" className="card p-5 hover:border-blue-500/40 transition-colors block">
              ...
              <p className="text-zinc-400 text-sm">Complete guide to all body recomposition peptides and stacking strategies.</p>
      ...
      {/* Products */}
      <section className="py-10 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6">
        <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Shop GLP-Class Peptides</h2>
      ...
      <section className="py-10 sm:py-20 max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <h2 className="text-3xl font-bold text-white mb-8">GLP Comparison Questions Answered</h2>
