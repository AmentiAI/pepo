    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--bg)' }}>
      ...
      <section className="relative pt-14 pb-12 sm:pt-28 sm:pb-20 overflow-hidden grid-bg">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-10 sm:mt-14 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
            {[
              { icon: <Zap size={18} className="text-violet-400" />, value: '8–12', label: 'Week full recovery' },
              { icon: <Clock size={18} className="text-cyan-400" />, value: '3–7', label: 'Days to pain relief' },
              { icon: <Syringe size={18} className="text-violet-400" />, value: '2×', label: 'Daily injections' },
              { icon: <Shield size={18} className="text-cyan-400" />, value: '500mcg', label: 'BPC-157 per dose' },
            ].map((stat) => (
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500">Body Protective Compound</p>
              </div>
            </div>
            <div className="space-y-3">
              <div className="flex justify-between text-sm">
                <span className="text-zinc-500">Dose</span>
                <span className="text-white font-semibold">500 mcg per injection</span>
              </div>
              <div className="flex justify-between text-sm">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-white font-semibold">Near shoulder / subacromial</span>
              </div>
              <div className="flex justify-between text-sm">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500">Thymosin Beta-4</p>
              </div>
            </div>
            <div className="space-y-3">
              <div className="flex justify-between text-sm">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="font-bold text-white">Protocol Duration</p>
            </div>
            <p className="text-zinc-400 text-sm">
              <span className="text-white font-semibold">8–12 weeks</span> for most rotator cuff
      ...
      <section className="py-10 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4 text-sm text-zinc-500">
          <Link href="/healing" className="hover:text-zinc-300 transition-colors">
