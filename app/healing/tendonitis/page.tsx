      ...
      <section className="relative pt-6 pb-12 sm:pt-10 sm:pb-20 overflow-hidden grid-bg">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-10 sm:mt-14 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
            {[
              { icon: <Zap size={18} className="text-yellow-600" />, value: '6–10', label: 'Week protocol duration' },
              { icon: <Clock size={18} className="text-yellow-600" />, value: '1–2', label: 'Weeks to pain relief' },
              { icon: <Syringe size={18} className="text-yellow-600" />, value: '250–500', label: 'mcg per injection' },
              { icon: <Shield size={18} className="text-yellow-600" />, value: '4+', label: 'Tendon types covered' },
            ].map((stat) => (
