      ...
      <section className="relative pt-6 pb-12 sm:pt-10 sm:pb-20 overflow-hidden grid-bg">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-10 sm:mt-14 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
            {[
              { icon: <Clock size={18} className="text-yellow-600" />, value: '24–48h', label: 'Ulcer healing onset' },
              { icon: <Droplets size={18} className="text-yellow-600" />, value: 'Oral + Injectable', label: 'Dual administration routes' },
              { icon: <Syringe size={18} className="text-yellow-600" />, value: '250mcg', label: 'Standard therapeutic dose' },
              { icon: <Shield size={18} className="text-yellow-600" />, value: '30+ yrs', label: 'Gastric research history' },
            ].map((stat) => (
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {conditions.map((cond) => (
              ...
              >
                ...
                <h3 className="font-bold text-gray-900 text-sm mb-1">{cond.name}</h3>
        ...
        <div className="grid md:grid-cols-3 gap-5 mb-8">
          ...
          <div className="card p-6 border border-yellow-400/40" style={{ background: 'var(--bg-card)' }}>
            <div className="flex items-center gap-2 mb-4">
              <Droplets size={18} className="text-yellow-600" />
              <h3 className="font-bold text-gray-900">Oral Administration</h3>
            </div>
