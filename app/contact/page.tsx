...
export const metadata: Metadata = {
  ...
  description:
    'Contact PeptidesClav for protocol questions, business inquiries, or partnership opportunities. Use our AI chat assistant for instant peptide protocol help.',
  openGraph: {
    title: 'Peptide Protocol Help & Business Inquiries | Contact',
    description: 'Get in touch with PeptidesClav for questions and business inquiries.',
    type: 'website',
  },
};
