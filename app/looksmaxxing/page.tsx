...
const whyPeptidesCards = [
  ...
  {
    icon: <Brain size={22} className="text-yellow-600" />,
  ...
  {
    icon: <Shield size={22} className="text-yellow-600" />,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4">
            ...
            <div
              ...
              style={{ borderColor: 'rgb(6 182 212)', backgroundColor: 'rgba(245,158,11,0.05)' }}
            >
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 p-5">
                <div className="shrink-0 w-28">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="card p-7">
            <div className="flex items-start justify-between flex-wrap gap-3 mb-5">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="text-xl font-bold text-gray-900">SNAP-8 (Argireline)</h3>
                  <span
                    className="text-xs px-2.5 py-1 rounded-full font-bold text-gray-700"
          ...
          <div className="card p-7">
            <div className="flex items-start justify-between flex-wrap gap-3 mb-5">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="text-xl font-bold text-gray-900">Epithalon</h3>
                  <span
                    className="text-xs px-2.5 py-1 rounded-full font-bold text-gray-700"
                    style={{ background: 'rgba(113,113,122,0.2)', border: '1px solid rgba(113,113,122,0.3)' }}
                  >
      ...
      <section className="py-10 sm:py-20" style={{ backgroundColor: 'var(--bg-card)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div className="card p-6">
              <div className="flex items-center gap-2 mb-4">
                <h3 className="text-lg font-bold text-gray-900">TB-500</h3>
                <span
                  className="text-xs px-2.5 py-1 rounded-full font-bold text-gray-700"
                  style={{ background: 'rgba(113,113,122,0.2)', border: '1px solid rgba(113,113,122,0.3)' }}
                >
        ...
        <div className="space-y-6">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              >
                <div className="flex items-start gap-2 mb-3">
                  <Shield size={15} className="text-yellow-600 mt-0.5 shrink-0" />
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-gray-700">Cycle: 12 weeks on, 4 weeks off</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card p-7">
            <div className="flex flex-wrap items-start justify-between gap-3 mb-5">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="text-xl font-bold text-gray-900">IGF-1 LR3</h3>
                  <span
                    className="text-xs px-2.5 py-1 rounded-full font-bold text-gray-700"
                    style={{ background: 'rgba(113,113,122,0.2)', border: '1px solid rgba(113,113,122,0.3)' }}
                  >
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="card p-7">
              <div className="flex items-center gap-2 mb-5">
                ...
                <span className="text-sm font-semibold text-gray-900">with Ipamorelin</span>
              </div>
            ...
            <div className="card p-7">
              <div className="flex items-center gap-2 mb-5">
                ...
                <span className="text-sm font-semibold text-gray-900">with BPC-157</span>
              </div>
              <p className="text-sm text-gray-700 leading-relaxed mb-4">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {quickLinkProducts.map((item) => (
              <Link
                ...
                className="px-4 py-2 rounded-xl text-sm font-semibold text-gray-700 transition-colors hover:text-gray-900"
                style={{
                  background: 'var(--bg)',
