    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--bg)' }}>
      ...
      <section className="relative pt-14 pb-12 sm:pt-28 sm:pb-20 overflow-hidden grid-bg">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-10 sm:mt-14 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
            {[
              { icon: <FlaskConical size={18} className="text-yellow-600" />, value: '3 Core Peptides', label: 'Semax, Selank, BPC-157' },
              { icon: <Brain size={18} className="text-yellow-600" />, value: 'BDNF', label: 'Key neurotrophin target' },
              { icon: <Zap size={18} className="text-yellow-600" />, value: 'Nasal + Subcut', label: 'Administration routes' },
              { icon: <Clock size={18} className="text-yellow-600" />, value: 'Rapid onset', label: 'Effects within 15–30 min' },
            ].map((stat) => (
      ...
      <section className="py-10 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 items-start mb-10">
          <div className="card p-6 border border-yellow-400/40" style={{ background: 'var(--bg-card)' }}>
      ...
      <section className="py-10 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="card overflow-hidden min-w-[480px]" style={{ background: 'var(--bg-card)' }}>
          ...
          <div className="grid grid-cols-3 border-b" style={{ borderColor: 'var(--border)' }}>
            ...
            <div className="p-4 border-l" style={{ borderColor: 'var(--border)' }}>
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold text-yellow-600">Selank</span>
              </div>
            </div>
          </div>
          ...
          {comparisonRows.map((row, i) => (
            ...
            >
              ...
              <div className="p-4 border-l" style={{ borderColor: 'var(--border)' }}>
                <p className="text-sm text-gray-900">{row.selank}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-6 grid sm:grid-cols-2 gap-4">
          ...
          <div className="card p-5 border border-yellow-400/40" style={{ background: 'var(--bg-card)' }}>
            <h4 className="font-bold text-yellow-600 mb-2">Choose Selank when:</h4>
            <ul className="space-y-1">
              {[
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            {protocols.map((protocol) => (
              ...
              >
                ...
                <h3 className="font-bold text-gray-900 text-base mb-5">{protocol.title}</h3>
                <div className="space-y-4">
