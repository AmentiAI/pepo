        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-6">
              ...
              <span className="text-white"> Bremelanotide</span>
            </h1>
              ...
              <tbody className="divide-y" style={{ borderColor: 'var(--border)' }}>
                {[
                  ...
                  <tr key={row.factor} className="hover:bg-white/2 transition-colors">
                    ...
                    <td className="py-3 px-4 text-zinc-300">{row.pt}</td>
                    <td className="py-3 px-4 text-zinc-300">{row.pde}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="card p-6 sm:p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Male Protocol</h2>
                <p className="text-xs text-zinc-500">Dosing for men</p>
              </div>
            </div>
            <div className="space-y-4 mb-6">
              {[
                ...
                >
                  <div className="px-3 py-1 rounded-lg text-xs font-semibold shrink-0 bg-violet-600/20 text-violet-300">
                    {item.label}
                  </div>
                  <div>
          ...
          <div className="card p-6 sm:p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Female Protocol</h2>
                <p className="text-xs text-zinc-500">Dosing for women (including FDA-approved Vyleesi)</p>
              </div>
            </div>
            <div className="space-y-4 mb-6">
              {[
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-amber-400 mb-2">Nausea Management Protocol</p>
      ...
      <section className="py-10 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {[
            ...
            {
              icon: <Heart size={20} className="text-cyan-400" />,
      ...
      <section className="py-10 sm:py-20 max-w-7xl mx-auto px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center gap-3 mb-10">
            ...
            <h2 className="text-2xl font-bold text-white">PT-141 FAQ</h2>
          </div>
          <div className="space-y-4">
            {pt141Faqs.map((faq, i) => (
              <div
